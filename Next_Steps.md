...
- [ ] Automate pre-commit mypy dependency audit for ephemeral runners (Owner: Platform, Due: 2025-12-10) — Schedule a weekly `uv run pre-commit run mypy --all-files` in CI and alert when dependency resolution or type stubs drift.
