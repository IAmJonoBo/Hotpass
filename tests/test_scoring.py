...
from hotpass.transform.scoring import (LeadScorer, LeadScoringModel,
                                       build_daily_list, score_prospects,
...
def test_lead_scorer_ranges():
    ...
    expect(
        0.0 <= low.value <= 1.0, f"Low score {low.value} should be between 0.0 and 1.0"
    )
