...
def _sample_report() -> QualityReport:
    return QualityReport(
        ...
        performance_metrics={
            ...
            "polars_transform_seconds": 0.12,
            "polars_materialize_seconds": 0.03,
            "pandas_sort_seconds": 0.2,
            "polars_sort_speedup": 2.5,
            "duckdb_sort_seconds": 0.05,
            "polars_write_seconds": 0.04,
