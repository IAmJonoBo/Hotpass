...
def test_enhanced_pipeline_with_geospatial_and_enrichment(
    ...
    monkeypatch.setattr(pipeline_features, "geocode_dataframe", fake_geocode_dataframe)
    monkeypatch.setattr(pipeline_features, "enrich_dataframe_with_websites", fake_enrich_websites)
    monkeypatch.setattr(pipeline_features, "CacheManager", FakeCache)
